    ...
    const handleSavePicture = async () => {
        ...
        try {
            ...
            if (error.response?.status === 403) {
                ...
                showNotification('error', 'Session Expired', 'Session expired. Please refresh the page and try again.');
            } else {
                showNotification('error', 'Upload Failed', 'Failed to upload picture. Please try again.');
            }
        ...
        if (newUsername.trim()) {
            ...
            try {
                ...
                if (error.response?.status === 403) {
                    ...
                    showNotification('error', 'Update Failed', 'Failed to update username. Please try again.');
                }
        ...
        if (newPassword && newPassword === confirmPassword) {
            ...
            try {
                ...
                if (error.response?.status === 403) {
                    ...
                    showNotification('error', 'Update Failed', 'Failed to update password. Please try again.');
                }
        ...
        if (window.confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
            ...
            try {
                ...
                if (error.response?.status === 403) {
                    ...
                    showNotification('error', 'Deletion Failed', 'Failed to delete account. Please try again.');
                }
                                    ...
                                    <div className="input-buttons">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                setShowPictureUpload(false);
                                                setSelectedFile(null);
                                                setProfileImage(user?.userPicture || null);
                                                if (fileInputRef.current) {
                                                    fileInputRef.current.value = '';
                                                }
                                            }}
